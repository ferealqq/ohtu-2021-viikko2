...
from viitegeneraattori import viitegeneraattori as vg_default


class Kauppa:
    def __init__(self,varasto = varasto_default, pankki = pankki_default, viitegeneraattori = vg_default):
